...
public class AdministracionPermisosClient {
	...
	public void assertPuedeVerNotasDeAlumno(String authorizationHeader, Long alumnoUsuarioId) {
		ejecutarPermiso(authorizationHeader, "Sin permiso para ver notas de este alumno",
				"/api/permisos/puedo-ver-notas-de/{id}", alumnoUsuarioId);
	}
